Register into Gridlastic using a data driven table Test Specification
=====================================================================

Created by Osanda Deshan on 5/24/2017

This is an executable specification file which follows markdown syntax.
Every heading in this file denotes a scenario. Every bulleted point denotes a step.

    |First_Name|Last_Name    |Comapany |Work_Email                    |Username       |Password |
    |----------|-------------|---------|------------------------------|---------------|---------|
    |Osanda    |Deshan       |MaxSoft  |osanda.deshan16@maxsoft.com   |osandadeshan16 |Osanda@92|
